  ...
  return (
    <div className="Projects">
        ...
        <div className="container">
          <a href = "https://github.com/fasttrackd-student-work/spring-assessment-social-media-team-sprint1"> <h3>Mock Twitter Backend</h3> </a>
          ...
          <a href= "https://pixelmaze.herokuapp.com/"> <h3>PixelMaze</h3> </a>
            <dl>A pacman like game made in Javascript. The game was made up an array of numbers, with each number having different atributes. By pushing the keycode the number 0 would move along the array based on the direction given. This simulated movment that the player could use to get around and gain points. Gaining enough points allowed the user to put their name on the hall of fame.</dl>
          <a href="https://github.com/fasttrackd-student-work/js-assessment-dev-duel-ACoolCat"><h3>Dev Duel</h3></a>
          ...
          <a href= "https://animefinder.herokuapp.com/"><h3>AnimeFinder</h3></a>
