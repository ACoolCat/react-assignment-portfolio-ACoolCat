function Story() {
  ...
  return (
    <div className="Story">
        ...
        <p> I'm originally from Ft. Lauderdale Florida, however, I will be moving to Memphis Tennesse on the first of March.</p>
        <h3>What is my educational background?</h3>
         <ul>
